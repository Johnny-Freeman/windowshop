datf <- read.csv("E:/R_script/REMOVED/csv_input/merged_allgene_alltissue.csv", stringsAsFactors = FALSE, header=TRUE)
datfb <- t(datf)

datfc <- (as.character(datf))
...
vgenes <- c("SLC22A7","SLC34A1","SLC13A1","SLC6A20","SLC38A4","SLC3A2")
